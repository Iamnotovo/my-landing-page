...
function Footer() {
  return (
    <footer className="relative bg-white border-t border-[#151A36]/15">
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[#151A36] text-base font-[Outfit] font-normal">
              ...
              <div className="flex items-center gap-4">
                <div className="w-6 h-6 flex items-center justify-center">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14 3H2C1.45 3 1 3.45 1 4V12C1 12.55 1.45 13 2 13H14C14.55 13 15 12.55 15 12V4C15 3.45 14.55 3 14 3ZM14 12H2V6L8 9L14 6V12ZM8 7L2 4H14L8 7Z" fill="#151A36"/>
                  </svg>
                </div>
                <span className="text-[#151A36] text-base font-[Outfit] font-medium">Contact Us</span>
                <span className="text-[#151A36] text-sm font-[Outfit] font-light leading-6">
          ...
          <div className="flex flex-col gap-6">
            <h3 className="text-[#151A36] text-xl font-[Outfit] font-medium capitalize">
              Quick Links
            </h3>
            <div className="flex flex-col gap-4 opacity-70">
              <a href="#" className="text-[#151A36] text-sm font-[Outfit] font-light capitalize hover:text-[#3d4767] transition-colors">
                About
              </a>
              <a href="#" className="text-[#151A36] text-sm font-[Outfit] font-light capitalize hover:text-[#3d4767] transition-colors">
                Blog
        ...
        {/* Bottom section */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-[#151A36]/15">
          <div className="text-[#151A36] text-base font-[Outfit] font-normal">
            © All Rights Reserved
          </div>
