  ...
  return (
    <section id="hero" className="relative min-h-screen bg-[#151A36] text-white overflow-hidden">
      ...
      <div className="hidden xl:block relative mx-auto min-h-[900px] px-6 sm:px-10 lg:px-16 xl:px-0 w-full max-w-[1440px] 2xl:max-w-[1800px]">
        ...
        <div 
          ref={mainTextRef}
          className={`absolute left-2 sm:left-8 lg:left-[48px] xl:left-[200px] 2xl:left-[250px] top-[180px] sm:top-[240px] xl:top-[290px] w-full max-w-[700px] lg:max-w-[800px] xl:max-w-[750px] 2xl:max-w-[900px] z-20 transition-all duration-700 ${
